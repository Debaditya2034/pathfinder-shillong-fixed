...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold tracking-tight transition-[transform,background,box-shadow,color] duration-200 smooth-ease focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pf-green focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:-translate-y-[1px] active:translate-y-[0.5px]",
  {
    variants: {
      variant: {
        default:
